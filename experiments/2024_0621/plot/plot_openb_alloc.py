...
policy_keep = ['Random', 'DotProd', 'Clustering', 'Packing', 'BestFit', 'FGD', 'Delay']
policy_keepr = ['Delay', 'FGD', 'BestFit', 'Packing', 'Clustering', 'DotProd', 'Random']
...
if TYPE=='alloc':
    ...
    hue_order=policy_keep, style_order=policy_keepr, palette=colors,dashes=dashes)
