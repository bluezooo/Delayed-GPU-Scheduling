...
func New(opts ...Option) (Interface, error) {
	...
	bindRegistry := frameworkruntime.Registry{
		...
		simontype.DelayScorePluginName: func(configuration runtime.Object, handle framework.Handle) (framework.Plugin, error) {
			return simonplugin.NewDelayScorePlugin(configuration, handle, &sim.typicalPods)
		},
	}
